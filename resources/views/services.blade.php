...
<head>
	<title>Lively Chat a Corporate Category Bootstrap Responsive Web Template | Services :: W3layouts </title>
	<!--/tags -->
...
<body>
						...
						<nav>
							<ul class="nav navbar-nav">
								...
								<li class="dropdown active">
									<a href="/services" class="dropdown-toggle" data-toggle="dropdown">Support <b class="caret"></b></a>
	...
	<div class="features" id="features">
		<div class="container">
			<div class="tittle_head_w3layouts">
				<h3 class="tittle">what <span>we have</span></h3>
			</div>
	...
	<div class="services-section" id="services">
		<div class="container">
			<div class="tittle_head_w3layouts">
				<h3 class="tittle">Our <span>Serevices</span></h3>
			</div>
			<div class="inner_sec_info_agileits_w3">
				<div class="col-md-4 services-section-grid_wthree_agile">
					<div class="services-section-grid_wthree_agile-head">
