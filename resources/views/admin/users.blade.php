...
<div id="page-wrapper">
  <div class="main-page">
    ...
    <div class="col-md-6" style="margin-top:10%">
      ...
      <form action="/admin/userLogs" method="GET">
            {{ csrf_field() }}
   <div class="form-group">
      ...
      <div class="col-md-12 widget-shadow">
        <ul id="myTabs" class="nav nav-tabs" role="tablist" style="margin-top: 35px;">
          <li role="presentation" class="active"><a href="#home" id="home-tab" role="tab" data-toggle="tab" aria-controls="home" aria-expanded="false">User</a></li>
