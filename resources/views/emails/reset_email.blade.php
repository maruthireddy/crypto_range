                                    ...
                                    <table width="245" border="0" cellspacing="0" cellpadding="0" class="scale">
                                        ...
                                        <tr>
                                            <td align="center" class="go-agile">
                                                <a href="{{URL::to('/reset_password/').'/'.$verification_key}}" style="font-family:'Candara', sans-serif; color: #fefefe; font-size: 16px; text-decoration: none; background-color: #00a78e; padding: 12px 26px 13px 26px; border-radius: 4px; border: 2px solid #FFFFFF;">Verify</a>
                                            </td>
                                        </tr>
                                    </table>
                                </td>
