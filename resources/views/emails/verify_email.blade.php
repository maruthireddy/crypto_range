                            ...
                            <tr>
                                <td class="center-w3">
                                    <table class="center-img" width="100%" border="0" cellspacing="0" cellpadding="0" align="center">
                                        ...
                                        <tr>
                                            <td>
                                                <img class="intr2" img src='http://cryptorange.io/images/crypto_range.svg' width='110' height='40' style="display: block; max-width: 275px; height:230px; border-top-right-radius: 8px; border-bottom-right-radius: 8px;" alt="" width="275" editable="true" />CRYPTO<span style="color:#ffcc00;">&nbsp;RANGE</span><label>&nbsp;</label>
                                            </td>
                                        </tr>
                                    ...
                                    <table width="245" border="0" cellspacing="0" cellpadding="0" class="scale">
                                        ...
                                        <tr>
                                            <td align="center" class="go-agile">
                                                <a href="{{URL::to('/email_verification/').'/'.$verification_key}}" style="font-family:'Candara', sans-serif; color: #fefefe; font-size: 16px; text-decoration: none; background-color: #00a78e; padding: 12px 26px 13px 26px; border-radius: 4px; border: 2px solid #FFFFFF;">Verify</a>
                                            </td>
                                        </tr>
                                    </table>
                                </td>
