...
<head>
    <title>Lively Chat a Corporate Category Bootstrap Responsive Web Template | Mail :: W3layouts </title>
    <!--/tags -->
                        ...
                        <ul class="nav navbar-nav">
                            ...
                            <li class="dropdown">
                                ...
                                <ul class="dropdown-menu">
                                    ...
                                    <li class="divider"></li>
                                    <li><a href="/single">One more link</a></li>
                                </ul>
                            </li>
                            <li><a href="/plans">Plans</a></li>
                            <li><a href="/blog">Blog</a></li>
                            <li class="active"><a href="/mail">Mail Us</a></li>
                        </ul>
                    </nav>
                </div>
                <!--/.navbar-collapse-->
        ...
        <div class="inner_sec_info_agileits_w3">
            <div class="contact-text">
                <div class="con-text">
                    ...
                    <p>+09187 8088 9436</p>
                    <h6>8088 USA, Honey block,New York City.</h6>
                </div>
            </div>
